...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('warehouse-location/activate-deactivate/{warehouse_id}', [WarehouseLocationController::class, 'activateDeactivateLocation']);

    //Business Location Settings...
    Route::prefix('warehouse-location/{warehouse_id}')->name('warehouse.')->group(function () {
        Route::get('settings', [LocationSettingsController::class, 'index'])->name('settings');
        Route::post('settings', [LocationSettingsController::class, 'updateSettings'])->name('settings_update');
    });

    //Business Locations...
    Route::post('warehouse-location/check-location-id', [WarehouseLocationController::class, 'checkLocationId']);
