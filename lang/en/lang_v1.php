...
return [
    ...
    'select_location' => 'Select Warehouse',
    ...
    'selling_price' => 'HET',
    'selling_price_ins' => 'HET (Only in numbers)',
    ...
    'location_ins' => 'If blank first Warehouse Location will be used',
    'location_ins1' => 'Name of the Warehouse Location',
    ...
    'tooltip_enable_racks' => 'Enable this to add rack details of a product for different Warehouse Locations while adding products',
    'rack_details' => 'Rack/Row/Position Details',
    'tooltip_rack_details' => 'Enter details of where the product is kept in the store, for different Warehouse Locations.',
    ...
    'position' => 'Position',
    'weight' => 'Weight',
    'rack_help_text' => "Rack details seperated by '|' for different Warehouse Locations serially.<br/> (Ex: R1|R5|R12) ",
    'row_help_text' => "Row details seperated by '|' for different Warehouse Locations serially.<br/> (Ex: ROW1|ROW2|ROW3) ",
    'position_help_text' => "Position details seperated by '|' for different Warehouse Locations serially.<br/> (Ex: POS1|POS2|POS3) ",
    ...
    'selling_price_group' => 'HET Group',
    'all_selling_price_group' => 'All HET Group',
    'add_selling_price_group' => 'Add HET Group',
    'edit_selling_price_group' => 'Edit HET Group',
    ...
    'default_selling_price_inc_tax' => 'Default HET (Inc. Tax)',
    'variation' => 'Variation',
    'price_group' => 'Price Group',
    'group_price' => 'Group Price',
    'default_selling_price' => 'Default HET',
    'price_group_help_text' => 'HET Group in which you want to sell',
    ...
    'minimum_selling_price_error_msg' => 'Minimum HET is :price',
    ...
    'default_selling_price_group' => 'Default HET Group',
    ...
    'product_business_location_tooltip' => 'Product will be available only in this Warehouse Locations',
    ...
    'business_location_activated_successfully' => 'Warehouse Location activated successfully',
    'business_location_deactivated_successfully' => 'Warehouse Location deactivated successfully',
    ...
    'choose_location_and_group_by' => 'Choose Warehouse Location and column by which sell lines will be grouped',
    ...
    'product_locations_ins' => 'Comma separated string of Warehouse Location names where product will be available',
    ...
    'business_location_address' => 'Warehouse Location address',
